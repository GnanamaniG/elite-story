...
const NAV = [
  ...
  { id:'healthscore',   label:'Business Health',     icon:'💚' },
  ...
  { id:'coupons',       label:'Coupon Manager',      icon:'🏷️' },
  ...
  { section:'Retention & Supply' },
  { id:'winback',       label:'Win-Back Campaigns',  icon:'🔄' },
  { id:'recurring',     label:'Recurring Orders',    icon:'🔁' },
  { id:'pricehistory',  label:'Price History',       icon:'📉' },
  { id:'supplierscore', label:'Supplier Scorecard',  icon:'🏅' },
  { section:'Tools' },
