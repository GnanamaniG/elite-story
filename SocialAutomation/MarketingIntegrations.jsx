    ...
    <div style={{ padding:22, background:T.bg, minHeight:'100%' }}>
      ...
      <Section title="📘 Meta Graph API — Access Token" desc="One token powers both Instagram posting and WhatsApp sending below">
        ...
        <Guide steps={[
          ...
          'This is the step that needs Meta App Review before it works for anyone other than test accounts you\\'ve added — expect a few days to a couple of weeks for approval',
      ...
      <Section title="💬 WhatsApp Business API" desc="Sends your campaign as an approved template message to your customer list">
        ...
        <Guide steps={[
          ...
          'Create a Message Template under Message Templates — WhatsApp requires business-initiated messages to use a pre-approved template, you cannot send free-form text to someone who hasn\\'t messaged you first',
