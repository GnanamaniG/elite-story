...
export const ROLE_PAGES = {
  ...
  manager: [
    ...
    'reportshub','gsthub','loyaltyhub','marketinghub','hrhub','opshub','toolshub','settings',
  ],
  accountant: [
    'dashboard','saleshub','purchhub','expenses','reportshub',
    'accountinghub','gsthub','custhub','settings',
  ],
  cashier: [
    'dashboard','pos','saleshub','custhub',
  ],
  staff: [
    'dashboard','pos','invhub','custhub','hrhub',
  ],
};
