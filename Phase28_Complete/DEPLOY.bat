...
cd /d "%BASE%"
git add .
git commit -m "Phase 28 - Hub consolidation + Stock Adj, Payment Reminders, Supplier Payments, P&L, QR Attendance"
git push origin master
echo Done! Sidebar reduced from 37 to 16 items.
pause
