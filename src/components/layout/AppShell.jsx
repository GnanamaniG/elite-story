      ...
      <div style={{ flex:1, display:'flex', flexDirection:'column', overflow:'hidden' }}>
        ...
        <div style={{ height:50, background:T.srf, borderBottom:`1px solid ${T.bdr}`, display:'flex', alignItems:'center', padding:'0 14px', gap:10, flexShrink:0 }}>
          ...
          {tenant?.plan_status === 'trial' && (
            <div onClick={() => onNavigate('billing')} style={{ background:T.amber+'18', border:`1px solid ${T.amber}44`, borderRadius:6, padding:'3px 10px', fontSize:11, color:T.amber, cursor:'pointer' }}>Trial → Upgrade</div>
          )}
